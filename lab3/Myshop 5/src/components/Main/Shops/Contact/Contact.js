...
import map from '../../../../media/appIcon/mapss.png';
            ...
            <View style={wrapper}>
                ...
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>Xom Hong Yen/ Dien Ngoc</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0963794862</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>kudo.aff@gmail.com</Text>
                    </View>
